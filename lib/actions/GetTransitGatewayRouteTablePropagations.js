 ...
 * Endpoint Path: '/#GetTransitGatewayRouteTablePropagations'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        spec: spec,
        operationId: 'GetTransitGatewayRouteTablePropagations',
        pathName: '/#GetTransitGatewayRouteTablePropagations',
        method: 'post',
