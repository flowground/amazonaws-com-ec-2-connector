 ...
 * Endpoint Path: '/#GetTransitGatewayAttachmentPropagations'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        spec: spec,
        operationId: 'GetTransitGatewayAttachmentPropagations',
        pathName: '/#GetTransitGatewayAttachmentPropagations',
        method: 'post',
